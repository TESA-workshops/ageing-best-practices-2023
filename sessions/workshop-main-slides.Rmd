...
- Identify opportunities to have otolith exchanges between labs, and to be able to connect with secondary age readers
...
- Shared references related to age determination, ideally something searchable, perhaps even a narrative of relevant literature by topic? 
- Development of a DFO tool to manage otolith images
- Use of SmartDots for image annotation
- ...
- Recognize the training requirements that lead to technicians that can perform reliable age estimation
- Recognize that all DFO regions perform analytical endeavours that involve age estimation 
- Recognize that having a forum to move towards best practices in age estimation is important
...
- SmartDots reporting features (Julie Davies and Daniel Ricard)
...
- CatchR: Methods developed to compute age-length keys for the northern Gulf of St. Lawrence Atlantic Cod, and prospects for other age-based assessments - Andrew Smith (IML)

- Kim Emond and Hélène Dionne (IML) - Catch-at-age of commercial herring landings and numbers-at-age from acoustics surveys

- Developing aging clocks for fish using DNA methylation (team from Dalhousie)
