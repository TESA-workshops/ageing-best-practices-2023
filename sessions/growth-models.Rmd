...
urlcolor: blue
header-includes:
- \AtBeginDocument{\title[Growth models]{A primer on fitting growth models to age estimates}}
...
- the basis of the model is that growth is the result of the opposing forces of anabolism and catabolism
...
````{verbatim}
VB.fit <- nls(
  length ~ (Linf+(sex.n*Linf.sex.dev))*
    (1 - exp((-k+(sex.n*k.sex.dev)) * 
               (age - t0)
             )
     ),
  data=x,
